...
\Tom{formalism -> invariant}

\Tom{abstract representation}
...
\Tom{Deleted here all mention of mapping from flows to derivations, as this was missleading in this context. It will be covered in greater detail later instead.}
...
Given two flows $\phi_1=(V_1,E_1,\eta_1,\up_1,\lo_1)$ and $\phi_2=(V_2,E_2,\eta_2,\up_2,\lo_2)$, an (\emph{atomic}) \emph{flow isomorphism}\index{flow!isomorphism} between $\phi_1$ and $\phi_2$ is a pair of functions $(f_V,f_E)$, such that
\begin{itemize}
...
\Tom{Removed superfluos clause and rephrased slightly to avoid overfull.}
...
\Tom{Renamed a $\psi$ to a $\phi$ and added example.}
